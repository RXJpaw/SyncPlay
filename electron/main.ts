...
import { getUpdater, getVersions } from './methods'
import path from 'path'
import fs from 'fs'
import './updater'

//Prevents stalling/proxy negotiation when reconnecting.
...
const customProtocol = 'rxjsyncplay'
...
async function createWindow() {
    ...
    const mainWindow = new BrowserWindow({
        width: 720 * zoomFactor * (10 / 16),
        height: 720 * zoomFactor,
        minWidth: 720 * zoomFactor * (10 / 16),
        minHeight: 720 * zoomFactor,
        //no maxWidth for debugging purposes
